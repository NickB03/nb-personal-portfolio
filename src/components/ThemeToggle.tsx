  ...
  return (
    ...
    >
      {showDarkIcon() ? (
        ...
        >
          <Sun className="h-5 w-5 text-white hover:text-superhuman-light transition-colors" />
        </motion.div>
      ) : (
        <motion.div
          initial={{ rotate: 0 }}
          ...
          transition={{ duration: 0.5 }}
        >
          <Moon className="h-5 w-5 text-superhuman-purple hover:text-superhuman-blue transition-colors" />
        </motion.div>
      )}
    </Button>
  );
